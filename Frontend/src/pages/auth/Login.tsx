...
function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        else if (data.rol === "Alumno") navigate("/Dashboard");
      } else {
  ...
  return (
    <div className="login-page">
      {/* MARCA EN ESQUINA INFERIOR IZQUIERDA (Opcional, si quieres mantener el logo de Morón sobre la foto) */}
          ...
          <div className="login-body">
            ...
            <form className="login-form" onSubmit={handleLogin}>
              ...
              <p className="login-help-text">
                ¿Necesitás ayuda?{" "}
                <Link to="/support" className="login-help-link">Contactá al soporte</Link>
              </p>

              <p className="login-help-text">
                ¿No tienes cuenta?{" "}
                <Link to="/Register" className="login-help-link">Registrarse</Link>
              </p>
            </form>
          </div>
